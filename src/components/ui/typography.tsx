...
export const BlockQuote = createComponent<HTMLQuoteElement>('blockquote', 'mt-6 border-l-2 pl-6 italic', 'BlockQuote');
...
export const MultilineCode = createComponent<HTMLPreElement>(
  'pre',
  'relative rounded bg-muted p-4 font-mono text-sm font-semibold overflow-x-auto text-wrap',
  'MultilineCode',
);
